...
import { buildTool } from '../ai-employees/server-utils.js';
import type {
...
export class AgentService {
  ...
  private async resolveLLM(_request: AgentRequest): Promise<{
    provider: import('../llm-providers/provider.js').LLMProvider;
  ...
  private async *executeStream(
    ...
    let activeProvider:
      import('../llm-providers/provider.js').LLMProvider | undefined;
