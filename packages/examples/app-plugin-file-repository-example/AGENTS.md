...
register both plugins in the target App, core first. Keep user documentation in
Chinese. Route authentication and advanced streaming remain explicitly deferred
by the approved first-version design.
