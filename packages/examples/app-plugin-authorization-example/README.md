...
| [sales-authorization.ts](server/sales-authorization.ts)                                            | Registration: `authz.sections.add`, `authz.database.collections.add`, `authz.business.define`, `authz.recordAccess.define`                   |
