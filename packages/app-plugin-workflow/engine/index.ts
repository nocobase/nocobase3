...
export const condition: typeof ConditionInstruction.create =
  ConditionInstruction.create.bind(ConditionInstruction);
export const run: typeof RunInstruction.create =
  RunInstruction.create.bind(RunInstruction);
export {
  compileToFlatIr,
