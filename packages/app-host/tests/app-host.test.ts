...
it('serves the packaged app-dist fixture', async () => {
  ...
  const releaseIdsByApp = Object.fromEntries(
    ['crm', 'orders', 'service-desk'].map((appId) => [
      appId,
      releases.releases
  ...
  expect(releaseIdsByApp).toMatchObject({
    crm: expect.arrayContaining([
      'release-crm-database-content-v1',
      'release-crm-database-v1',
      'release-crm-database-v2',
      'release-crm-native-v1',
      'release-crm-settings-shell-v1',
      'release-crm-settings-shell-v2',
      'release-v1',
      'release-v2',
      'release-v3',
    ]),
  ...
  await expect(
    host.appCatalog.resolveRelease('crm', 'release-v2'),
  ).resolves.toMatchObject({
    id: 'crm',
    desiredVersion: '2.0.0',
    code: {
      checksum:
        'b714b7df15dd51e51fa370156ac261f91862a65d23b8899f6c5c3fb7ed58299c',
    },
    release: {
      id: 'release-v2',
      version: '2.0.0',
  ...
  await expect(
    host.appCatalog.resolveRelease('service-desk', 'release-v2'),
  ).resolves.toMatchObject({
    id: 'service-desk',
    desiredVersion: '2.0.0',
    code: {
      checksum:
        '2e1d5307b5dfc92359486e231aeb1e04df4061a4ace9cea320382f5c01581ef2',
    },
    release: {
      id: 'release-v2',
      version: '2.0.0',
