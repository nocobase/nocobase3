...
export interface FilesModuleOptions { db: unknown; config: unknown; requestContext: FileRequestContextResolver; authorizer: FileAuthorizer; drivers: Record<string, unknown>; now?: () => Date; generateId?: () => string }
