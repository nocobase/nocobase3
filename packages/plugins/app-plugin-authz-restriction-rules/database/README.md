...
```text
202609160001_authz_restriction_rules_create_records.ts.example
202609160001_authz_restriction_rules_create_records.ts

202609160002_authz_restriction_rules_create_welcome_record.ts.example
202609160002_authz_restriction_rules_create_welcome_record.ts
```
