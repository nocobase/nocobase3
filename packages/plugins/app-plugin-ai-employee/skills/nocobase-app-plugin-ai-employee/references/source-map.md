...
| ----------------------------- | ------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `chat`                        | `index`, `container-showcase`, `interaction-showcase`, `prompt-generator` | `AIChatWindow` in each container — `ChatInline`, `ChatPage`, `ChatSurface` — message interactions, and the web search toggle as a composer action                                   |
