export default {
  ...
  tools: {
    title: '工具',
    description: '浏览 AI 员工可用的工具，查看使用说明和输入参数。',
    search: '搜索工具',
    searchPlaceholder: '搜索工具名称、标识或介绍',
    count_other: '共 {{count}} 个工具',
    loading: '正在加载工具…',
    error: '无法加载工具。',
    empty: '暂无可用工具。',
    noMatches: '没有匹配的工具。',
    ...
    source: '来源',
    details: '工具详情',
    detailsDescription: '阅读工具说明并查看其输入结构。',
    detailsLoading: '正在加载工具详情…',
    detailsError: '无法加载工具详情。',
    about: '工具介绍',
  ...
  skills: {
    count_other: '共 {{count}} 个技能',
    skill: '技能',
    description: '描述',
    tools: '工具',
    details: '技能详情',
    instructions: '技能说明',
    toolsDescription: '此技能引用的工具。详情仅供查看。',
    detailsDescription: '阅读技能说明并查看其工具。',
    detailsLoading: '正在加载技能详情…',
    detailsError: '无法加载技能详情。',
    content: '技能说明',
    noContent: '暂无技能说明。',
    noTools: '无工具',
    toolAvailable: '可用',
  ...
  'demo.navigation.group': 'AI 组件',
  'demo.navigation.chat': '聊天窗口',
  'demo.navigation.floating': '悬浮聊天',
  'demo.navigation.tasks': '员工任务',
  'demo.navigation.context': '页面上下文',
  'demo.navigation.tools': '工具卡片',
  'demo.containerPatterns': '容器形式',
  'demo.promptGenerator': '提示词生成器',
  'demo.componentApi': '组件 API',
  'demo.manualContext': '手动选择上下文',
  'demo.shortcutContext': '任务上下文 · 快捷任务',
  'demo.presetContext': '任务上下文 · 对话预设',
  'demo.scopeContext': '任务上下文 · 作用域继承',
  'demo.builtinFrontendTool': '内置前端工具',
  'demo.customFrontendTool': '自定义前端工具',
  'demo.specializedRenderers': '专用渲染器',
  'demo.defaultToolCard': '默认工具卡片',
  'demo.codePrompt': '代码提示词',
  ...
  'usage.pageDescription': '按 AI 员工、模型和用户查看 Token 消耗与调用量。',
  'usage.range.today': '今天',
  'usage.range.last7Days': '最近 7 天',
  'usage.range.last30Days': '最近 30 天',
  'usage.range.last90Days': '最近 90 天',
  'usage.filter.range': '时间范围',
  'usage.filter.aiEmployee': 'AI 员工',
  'usage.filter.allAiEmployees': '全部 AI 员工',
  'usage.filter.model': '模型',
  'usage.filter.allModels': '全部模型',
  'usage.metric.totalTokens': '总 Token',
  'usage.metric.inputTokens': '输入 Token',
  'usage.metric.outputTokens': '输出 Token',
  'usage.metric.cachedTokens': '缓存 Token',
  'usage.metric.uncachedInputTokens': '未缓存输入',
  'usage.metric.reasoningTokens': '推理 Token',
  'usage.metric.llmCalls': '模型调用次数',
  'usage.metric.toolCalls': '工具调用次数',
  'usage.vsPreviousPeriod': '较上一周期',
  'usage.noComparison': '无对比数据',
  'usage.summary': '汇总',
  'usage.trend': '趋势',
  'usage.breakdown': '分维度统计',
  'usage.dimension.model': '模型',
  'usage.dimension.aiEmployee': 'AI 员工',
  'usage.dimension.user': '用户',
  'usage.share': '占比',
  ...
  'Search by title or session ID': '按标题或会话 ID 搜索',
  Search: '搜索',
  'Selected conversation': '选中的会话',
  ...
  'My conversations': '我的会话',
  'Created at': '创建时间',
  'Updated at': '更新时间',
  'Last message at': '最后消息时间',
  Messages: '消息',
  'Message count': '消息数量',
  Model: '模型',
  Metadata: '元数据',
  ...
  'Select a conversation to view its messages.': '选择一个会话以查看消息。',
  'No messages in this conversation.': '此会话暂无消息。',
