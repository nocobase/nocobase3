export default {
  ...
  'usage.range.last90Days': 'Last 90 days',
  'usage.filter.range': 'Time range',
  'usage.filter.aiEmployee': 'AI employee',
  'usage.filter.allAiEmployees': 'All AI employees',
  ...
  'usage.metric.cachedTokens': 'Cached tokens',
  'usage.metric.uncachedInputTokens': 'Uncached input',
  'usage.metric.reasoningTokens': 'Reasoning tokens',
  'usage.metric.llmCalls': 'LLM calls',
  'usage.metric.toolCalls': 'Tool calls',
  'usage.vsPreviousPeriod': 'vs. previous period',
  'usage.noComparison': 'No comparison data',
  'usage.summary': 'Summary',
  'usage.trend': 'Trend',
  'usage.breakdown': 'Breakdown',
  'usage.dimension.model': 'Model',
  'usage.dimension.aiEmployee': 'AI employee',
  'usage.dimension.user': 'User',
  'usage.share': 'Share',
  ...
  'usage.loadFailed': 'Unable to load usage statistics',
