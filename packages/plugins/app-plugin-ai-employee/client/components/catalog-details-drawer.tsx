      ...
      {open ? (
        <DialogPortal>
          ...
          <DialogPrimitive.Popup
            ...
            className='fixed inset-y-0 right-0 z-50 flex h-dvh w-full min-w-0 max-w-2xl flex-col overflow-hidden border-l bg-popover text-popover-foreground shadow-xl outline-none transition-transform duration-200 data-starting-style:translate-x-full data-ending-style:translate-x-full motion-reduce:transition-none'
          >
