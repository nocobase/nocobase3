...
// Hand-written for the default stores of @nocobase/authorization. The tables it
// creates are the ones documented in that package's docs/zh-CN/*/usage.md; keep
// both in step when the store changes.
