...
| `place(ref, { section, group? })`                        | Lists a resource, `{ type, id }` or a `CompositeResourceReference`, in a subsection and optionally a group. Placing in a top-level section throws; placing the same resource elsewhere throws.                                                                                                                                                                                                         |
