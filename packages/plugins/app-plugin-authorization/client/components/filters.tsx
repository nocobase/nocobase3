  ...
  return (
    <div className={cn('relative min-w-48 flex-1 sm:max-w-80', className)}>
      ...
      <input
        ref={inputRef}
        aria-label={label}
        className='h-9 w-full min-w-0 rounded-lg border border-input bg-background pr-8 pl-8 text-sm outline-none placeholder:text-muted-foreground focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50'
        disabled={disabled}
