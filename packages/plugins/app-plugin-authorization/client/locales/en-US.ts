...
const messages = {
  ...
  members: {
    open: 'Members',
    openNamed: 'Members of {{label}}',
    manage: 'Manage',
    manageNamed: 'Manage {{label}}',
    search: 'Search members',
    name: 'Name',
    description: 'Description',
    inspect: 'Inspect',
    inspectNamed: 'Inspect {{label}}',
    empty: 'This subject has no members.',
    emptyFiltered: 'No members match your search.',
    total: '{{count}} members',
    hint: 'Read-only. Members are managed where the subject is managed.',
  },
  editors: {
  ...
  inspector: {
    ...
    grantedVia: 'via {{label}}',
    grantedDirectly: 'assigned directly',
