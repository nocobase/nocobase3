...
const enUS = {
  ...
  dev: {
    ...
    templateManagementCategory: 'Reusable content',
    ...
    signatureManagementCategory: 'Account settings',
    ...
    noIdentities: 'No sending identities are available for this account.',
