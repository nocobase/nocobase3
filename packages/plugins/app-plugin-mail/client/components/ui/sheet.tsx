...
function SheetPortal({
  ...props
}: SheetPrimitive.Portal.Props): React.ReactElement {
          ...
          <SheetPrimitive.Close
            ...
            render={
              <Button
                ...
                className='absolute top-3 right-3 size-9 p-0'
                variant='ghost'
              />
            }
          >
