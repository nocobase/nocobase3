...
const zhCN: HubResource = {
  ...
  logs: {
    ...
    copy: '复制当前日志',
    download: '下载日志',
    downloadLimit: '下载超过 50 MB，请缩小时间范围。',
    rotated: '部分日志已轮转或过期，正在显示可用记录。',
    loading: '正在加载日志…',
    disabled: '日志采集已关闭。',
    unavailable: '没有可用的日志文件，可能尚未启用采集，或日志已过期。',
    empty: '没有匹配的日志。',
    stopped: '应用已停止，仍可查看保留的历史日志。',
  ...
  configuration: {
    ...
    secretAutoGeneration:
      '使用配置文件部署时，Hub 会自动为缺失、空白或示例占位的 auth.secret 生成安全随机密钥。session.secret 是可选覆盖项，未配置时默认使用 auth.secret。已有密钥会继续复用，自定义值会保留。外部配置不由 Hub 补全。',
