...
describe('createSessionManager', () => {
  ...
  it('parses session durations', () => {
    ...
    expect(() => parseSessionDuration('soon', 'Test')).toThrow('Test session duration "soon" is invalid.');
  });
...
function createTestApp(config: Partial<AppSessionConfig> = {}): Hono<SessionEnv<TestSessionData>> {
