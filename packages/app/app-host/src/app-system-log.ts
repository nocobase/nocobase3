...
export interface AppSystemLogInput {
...
export const writeAppSystemLog = (input: AppSystemLogInput): void => {
  ...
  const line = JSON.stringify({
    ...
    channel: 'system',
    mode: 'embedded',
    appName: input.definition?.appName ?? input.definition?.id ?? 'main',
