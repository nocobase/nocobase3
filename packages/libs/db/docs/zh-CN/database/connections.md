...
更完整的概念见 [命名概念](../concepts/naming/overview.md)，具体配置见 [`underscored` 命名规则](../concepts/naming/underscored.md) 和 [`tablePrefix` 表前缀](../concepts/naming/table-prefix.md)，Builder 编译规则见 [Builder 命名映射](../builder/naming.md)。
