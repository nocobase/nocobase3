...
| Select                    | [select](./relations/select.test.ts): four cardinalities, null/empty shapes, nested include, local filters/sorts, parent retention, Builder/AST parity, duplicate/unknown entries                                                                                                                  | More deep sibling/branch isolation and selection-budget boundaries                                                     |
...
| Aggregate Select          | [combine](./relations/aggregate-select.test.ts): exact aggregates, empty sets, records/count branches, branch filters, local limit/Distinct/cursor and invalid combinations                                                                                                                        | All-null values, more cardinality combinations and branch-budget boundaries                                            |
