...
export type OceanbaseConnection = OceanbaseOptions & {
  dialect: 'oceanbase';
  databaseDriver: typeof oceanbaseDriver;
};
export interface OceanbaseFactory {
  (options?: OceanbaseOptions): OceanbaseConnection;
  readonly dialect: 'oceanbase';
  readonly driver: typeof oceanbaseDriver;
}
export const oceanbase: OceanbaseFactory = Object.assign(
  (options: OceanbaseOptions = {}) => ({
    ...options,
    dialect: 'oceanbase' as const,
    driver: 'mysql2' as const,
    databaseDriver: oceanbaseDriver,
  }),
  { dialect: 'oceanbase' as const, driver: oceanbaseDriver },
);
export default oceanbase;
