...
- ceb356b: Use Oracle identity columns for auto-increment fields instead of Knex's legacy sequence and trigger implementation.
...
- Add the Oracle dialect factory, driver descriptor, schema inspector, session pool hooks, and Knex client integration for `@nocobase/db`.
