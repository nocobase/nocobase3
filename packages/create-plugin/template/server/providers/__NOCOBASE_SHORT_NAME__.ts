...
import { Default__NOCOBASE_SYMBOL_NAME__Service } from '../services/__NOCOBASE_SHORT_NAME__.js';
...
export class __NOCOBASE_SYMBOL_NAME__Provider extends ServiceProvider<__NOCOBASE_SYMBOL_NAME__ProviderApplication> {
