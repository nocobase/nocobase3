...
import type { ConnectionAdapter, ConnectionAdapterContext } from '../../factory.js';
...
export class KnexConnectionAdapter implements ConnectionAdapter<ConnectionConfig> {
  createConnection(context: ConnectionAdapterContext<ConnectionConfig>): DatabaseConnection {
