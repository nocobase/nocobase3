...
import { RouteDialog, RouteDrawer, RoutePage } from '../index';
      ...
      <div className='space-y-6'>
        ...
        {!nested ? (
          <Card>
            ...
            <CardContent>
              <Button onClick={() => navigate('list?status=renewal&page=2')}>
                Open customer list
                <ArrowRight />
              </Button>
            </CardContent>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='flex flex-wrap gap-2'>
            ...
            <Button variant='outline' onClick={() => openChild('detail/42')}>
              <Eye />
              Open detail
            </Button>
          </div>
