import { FileUp, FolderOpen, RotateCcw, Search } from 'lucide-react';
...
export function FileManagerDemoPage() {
  const [uploadValue, setUploadValue] = useState<FileUploadFieldValue>(null);
    ...
    <div className='space-y-8 pb-12'>
      <header className='space-y-2'>
        ...
        <p className='max-w-3xl text-sm leading-6 text-muted-foreground'>
          ...
          the server&apos;s attachments collection. New uploads are added to
          this page for the current browser session.
        </p>
      </header>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            text, audio, video, and Office documents use their matching
            previewer.
          </CardDescription>
        </CardHeader>
        <CardContent>
