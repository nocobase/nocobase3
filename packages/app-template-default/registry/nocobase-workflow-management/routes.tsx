...
export const workflowManagementRoutes = defineAppRoutes([
  {
    ...
    children: [
      ...
      },
      {
        ...
        path: 'workflows',
        outlet: 'manual',
        resource: { meta: { label: 'Workflows', parent: 'workflow' } },
        lazy: () =>
      ...
      },
      {
        ...
        path: 'runs',
        outlet: 'manual',
        resource: { meta: { label: 'Execution records', parent: 'workflow' } },
        lazy: () =>
