...
export class DatabaseAppSettingsRepository implements AppSettingsRepository {
...
export class UnavailableAppSettingsRepository implements AppSettingsRepository {
  async all(): Promise<AppSetting[]> {
