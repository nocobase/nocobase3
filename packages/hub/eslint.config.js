...
export default createPortalConfig({
  ...
  overrides: [
    ...
    {
      name: "hub/dynamic-contract-boundaries",
      files: [
    ...
    {
      name: "hub/dynamic-string-normalization",
      files: [
    ...
    {
      name: "hub/react-compiler-incremental-adoption",
      files: [
    ...
    {
      name: "hub/intentional-hook-stability",
      files: [
    ...
    {
      name: "hub/eslint-10-assignment-analysis",
      files: [
        "registry/nocobase-ai/providers/chat-provider.tsx",
        "registry/nocobase-mail/components/mail-api.ts",
      ],
