export const starter = {
  ...
  'hub.apps.actions.deployConfirmDescription':
    '确定要为 {{name}} 部署版本 {{version}} 吗？',
  'hub.apps.actions.redeployConfirmDescription':
    '确定要为 {{name}} 重新部署版本 {{version}} 吗？',
  'hub.apps.actions.deploying': '正在部署…',
  'hub.apps.actions.redeploying': '正在重新部署…',
  ...
  'hub.runtime.evict': '停止应用',
  'hub.runtime.stop': '停止应用',
  'hub.runtime.starting': '正在启动…',
  'hub.runtime.restarting': '正在重启…',
  'hub.runtime.stopping': '正在停止…',
  'hub.runtime.confirm.startTitle': '启动应用',
  'hub.runtime.confirm.startDescription': '确定要启动 {{name}} 的运行实例吗？',
  'hub.runtime.confirm.start': '确认启动',
  'hub.runtime.confirm.restartTitle': '重启应用',
  'hub.runtime.confirm.restartDescription':
    '确定要重启 {{name}} 的运行实例吗？进行中的请求可能会被中断。',
  'hub.runtime.confirm.restart': '确认重启',
  'hub.runtime.confirm.stopTitle': '停止应用',
  'hub.runtime.confirm.stopDescription':
    '确定要停止 {{name}} 的运行实例吗？再次启动前，应用将无法访问。',
  'hub.runtime.confirm.stop': '确认停止',
  'hub.runtime.error.start': '无法启动应用',
  'hub.runtime.error.restart': '无法重启应用',
  'hub.runtime.error.stop': '无法停止应用',
  ...
  'hub.members.enableTitle': '启用成员',
  'hub.members.disableTitle': '停用成员',
  'hub.members.enableConfirm': '确定要启用此成员并允许其重新登录吗？',
  'hub.members.enableAction': '确认启用',
  'hub.members.disableAction': '确认停用',
  'hub.members.enabling': '正在启用…',
  'hub.members.disabling': '正在停用…',
  'hub.members.statusError': '无法更新成员状态',
  ...
  'hub.invitations.revokeTitle': '撤销邀请',
  'hub.invitations.revokeConfirm':
    '确定要撤销这条邀请吗？撤销后邀请链接会立即失效。',
  'hub.invitations.revokeAction': '确认撤销',
  'hub.invitations.revoking': '正在撤销…',
  ...
  'hub.agentCredentials.revokeTitle': '撤销 Agent 凭据',
  'hub.agentCredentials.revokeConfirm':
    '确定要撤销这条 Agent 凭据吗？撤销后 Agent 会立即失去 Hub 访问权限。',
  'hub.agentCredentials.revokeAction': '确认撤销',
  'hub.agentCredentials.revoking': '正在撤销…',
...
6. 报告所有按要求创建的 Release 或 Deployment 的 ID、版本、状态、访问地址、checksum 和验证结果。不要向 Hub 上传源码、依赖、本地数据库、密钥或运行数据。`,
  ...
  'hub.runtimeSecret.confirmTitle': '轮换运行密钥',
  'hub.runtimeSecret.confirmAction': '确认轮换',
  'hub.runtimeSecret.rotating': '正在轮换…',
  ...
  'hub.audit.action.runtime.evicted': '停止应用',
