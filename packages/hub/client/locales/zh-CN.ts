export const starter = {
  ...
  'hub.apps.filter.statusAria': '按应用状态筛选',
  'hub.apps.filter.allRuntimeStates': '全部状态',
  ...
  'hub.invitation.expiry': '邀请链接的有效期',
  'hub.invitation.expiryUnit': '天',
  ...
  'hub.settings.description': '配置版本保留、审计保留和操作确认策略。',
