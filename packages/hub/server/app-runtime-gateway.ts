...
export function createAppRuntimeGatewayHeaders(
  ...
  // The Hub is the trusted gateway boundary. Never pass client-supplied
  // forwarding metadata to App Host because Apps use it to reconstruct their
  // public request origin for authentication and redirects.
