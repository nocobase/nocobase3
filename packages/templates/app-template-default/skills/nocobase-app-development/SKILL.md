...
| Audit HTTP requests, business phases, or selected table writes | [nocobase-app-plugin-audit](../../.agents/skills/nocobase-app-plugin-audit/SKILL.md) (synchronized plugin Skill) |
