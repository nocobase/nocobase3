...
export default function ChartExamplePage(): ReactElement {
  ...
  const channelConfig = {
    online: { label: t('devComponents.chart.online'), color: 'var(--chart-1)' },
    retail: { label: t('devComponents.chart.retail'), color: 'var(--chart-2)' },
  } satisfies ChartConfig;

  const planConfig = {
    free: { label: t('devComponents.chart.planFree'), color: 'var(--chart-1)' },
    pro: { label: t('devComponents.chart.planPro'), color: 'var(--chart-2)' },
  } satisfies ChartConfig;

  const ordersConfig = {
    orders: { label: t('devComponents.chart.orders'), color: 'var(--chart-1)' },
    returns: {
      label: t('devComponents.chart.returns'),
      color: 'var(--chart-5)',
    },
  } satisfies ChartConfig;

  const categoryConfig = {
    revenue: { label: t('devComponents.chart.revenue') },
    hardware: {
      label: t('devComponents.chart.hardware'),
      color: 'var(--chart-1)',
    },
    software: {
      label: t('devComponents.chart.software'),
      color: 'var(--chart-2)',
    },
    services: {
      label: t('devComponents.chart.services'),
      color: 'var(--chart-3)',
    },
    support: {
      label: t('devComponents.chart.support'),
      color: 'var(--chart-4)',
    },
    training: {
      label: t('devComponents.chart.training'),
      color: 'var(--chart-5)',
    },
  } satisfies ChartConfig;
  ...
  const quotaConfig = {
    attainment: {
      label: t('devComponents.chart.quotaAttainment'),
      color: 'var(--chart-2)',
    },
  } satisfies ChartConfig;
  ...
  return (
    <ExamplePage
      title={t('devComponents.chart.title')}
      description={t('devComponents.chart.description')}
      source='client/pages/dev/components/chart.tsx'
      docs='https://ui.shadcn.com/docs/components/chart'
    >
      <ExampleSection
        title={t('devComponents.chart.bar')}
        description={t('devComponents.chart.barDescription')}
      ...
      <ExampleSection
        title={t('devComponents.chart.area')}
        description={t('devComponents.chart.areaDescription')}
        contentClassName='block'
      >
        <Card className='w-full max-w-xl'>
          <CardHeader>
            <CardTitle>{t('devComponents.chart.signupsTitle')}</CardTitle>
            <CardDescription>
              {t('devComponents.chart.signupsDescription')}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ChartContainer
          ...
          <CardFooter className='gap-2 text-sm'>
            <span className='font-medium'>
              {t('devComponents.chart.trendingUp', { percent: '12.4%' })}
            </span>
      ...
      <ExampleSection
        title={t('devComponents.chart.line')}
        description={t('devComponents.chart.lineDescription')}
        contentClassName='block'
      >
        <ChartContainer
          config={ordersConfig}
      ...
      <ExampleSection
        title={t('devComponents.chart.pie')}
        description={t('devComponents.chart.pieDescription')}
        contentClassName='block'
      >
        <ChartContainer
                  ...
                  if (viewBox && 'cx' in viewBox && 'cy' in viewBox) {
                    return (
                      ...
                      >
                        ...
                        >
                          {t('devComponents.chart.revenueTotal')}
                        </tspan>
                      </text>
                    );
                  }
      ...
      <ExampleSection
        title={t('devComponents.chart.radial')}
        description={t('devComponents.chart.radialDescription')}
        contentClassName='block'
      >
        <ChartContainer
          config={quotaConfig}
                    ...
                    return (
                      ...
                      >
                        ...
                        <tspan
                          ...
                          className='fill-muted-foreground'
                        >
                          {t('devComponents.chart.quotaAttainment')}
                        </tspan>
                      </text>
                    );
                  }
