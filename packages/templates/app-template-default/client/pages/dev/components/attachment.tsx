...
export default function AttachmentExamplePage(): ReactElement {
  ...
  const removeLabel = (file: string): string =>
    t('devComponents.attachment.removeFile', { file });

  return (
    <ExamplePage
      title={t('devComponents.attachment.title')}
      description={t('devComponents.attachment.description')}
      source='client/pages/dev/components/attachment.tsx'
      docs='https://ui.shadcn.com/docs/components/attachment'
    >
      <ExampleSection
        title={t('devComponents.attachment.basic')}
        description={t('devComponents.attachment.basicDescription')}
      >
        <Attachment>
          <AttachmentMedia>
            <FileTextIcon />
      ...
      <ExampleSection
        title={t('devComponents.attachment.states')}
        description={t('devComponents.attachment.statesDescription')}
      ...
      >
        <Attachment state='idle' className='w-full max-w-sm'>
          ...
          <AttachmentContent>
            ...
            <AttachmentDescription>
              {t('devComponents.attachment.readyToUpload')}
            </AttachmentDescription>
          </AttachmentContent>
          <AttachmentActions>
        ...
        <Attachment state='uploading' className='w-full max-w-sm'>
          ...
          <AttachmentContent>
            ...
            <AttachmentDescription>
              {t('devComponents.attachment.uploadingProgress', {
                percent: '64%',
              })}
            </AttachmentDescription>
          </AttachmentContent>
          <AttachmentActions>
            <AttachmentAction
              aria-label={t('devComponents.attachment.cancelUpload')}
            >
              <XIcon />
            </AttachmentAction>
          </AttachmentActions>
        ...
        <Attachment state='processing' className='w-full max-w-sm'>
          ...
          <AttachmentContent>
            ...
            <AttachmentDescription>
              {t('devComponents.attachment.processingDocument')}
            </AttachmentDescription>
          </AttachmentContent>
          <AttachmentActions>
        ...
        <Attachment state='error' className='w-full max-w-sm'>
          ...
          <AttachmentContent>
            ...
            <AttachmentDescription>
              {t('devComponents.attachment.uploadFailed')}
            </AttachmentDescription>
          </AttachmentContent>
          <AttachmentActions>
            <AttachmentAction
              aria-label={t('devComponents.attachment.retryUpload')}
            >
              <RefreshCwIcon />
            </AttachmentAction>
        ...
        <Attachment state='done' className='w-full max-w-sm'>
          ...
          <AttachmentContent>
            ...
            <AttachmentDescription>
              {t('devComponents.attachment.uploadedMeta', { size: '1.8 MB' })}
            </AttachmentDescription>
          </AttachmentContent>
          <AttachmentActions>
      ...
      <ExampleSection
        title={t('devComponents.attachment.sizes')}
        description={t('devComponents.attachment.sizesDescription')}
      ...
      <ExampleSection
        title={t('devComponents.attachment.images')}
        description={t('devComponents.attachment.imagesDescription')}
              ...
              <AttachmentTrigger
                render={
                  <a
                    ...
                    target='_blank'
                    rel='noreferrer'
                    aria-label={t('devComponents.attachment.openFile', {
                      file: image.name,
                    })}
                  />
                }
      ...
      <ExampleSection
        title={t('devComponents.attachment.conversation')}
        description={t('devComponents.attachment.conversationDescription')}
        contentClassName='block'
      >
        <MessageGroup className='w-full max-w-md'>
          <Message>
            ...
            <MessageContent>
              <Bubble variant='muted'>
                <BubbleContent>
                  {t('devComponents.attachment.conversationCustomer')}
                </BubbleContent>
              </Bubble>
              <AttachmentGroup>
                <Attachment size='sm'>
          ...
          <Message align='end'>
            <MessageContent>
              <Bubble align='end'>
                <BubbleContent>
                  {t('devComponents.attachment.conversationReply')}
                </BubbleContent>
              </Bubble>
      ...
      <ExampleSection
        title={t('devComponents.attachment.composer')}
        description={t('devComponents.attachment.composerDescription')}
        contentClassName='block'
      >
        <InputGroup className='w-full max-w-md'>
          ...
          <InputGroupTextarea
            rows={2}
            placeholder={t('devComponents.attachment.composerPlaceholder')}
            aria-label={t('devComponents.attachment.composerLabel')}
          />
          <InputGroupAddon align='block-end' className='justify-between'>
            <InputGroupButton
              size='icon-xs'
              aria-label={t('devComponents.attachment.attachFile')}
            >
              <PaperclipIcon />
            </InputGroupButton>
            <InputGroupButton variant='default'>
              {t('devComponents.attachment.send')}
