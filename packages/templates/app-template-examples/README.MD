...
output: the workflow is `pnpm nocobase collections generate --connection externalCrm`
...
`pnpm nocobase collections generate --connection externalCrm` writes `collection.json`
...
| Command                              | What it does                                                                                |
| ------------------------------------ | ------------------------------------------------------------------------------------------- |
| `pnpm nocobase server-deps retarget` | Replace native binaries with the target platform's; part of `pnpm build`                    |
| `pnpm nocobase server-deps verify`   | Check that everything your server and CLI import reaches a deployment; part of `pnpm build` |
...
`pnpm nocobase db apply` when automatic startup tasks are disabled. Seeds insert missing
