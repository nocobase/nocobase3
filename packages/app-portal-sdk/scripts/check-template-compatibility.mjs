...
export const checkTemplateCompatibility = ({ silent = false } = {}) => {
  ...
  if (!supportedRange) {
    throw new Error(
      '@nocobase/app-portal-sdk does not declare nocobase.supportedDefaultTemplateRange.',
    );
  }
  ...
  if (!compatible) {
    throw new Error(
      [
        ...
        'Upgrade the base template first, or install a compatible @nocobase/app-portal-sdk version.',
      ].join('\n'),
    );
  }
