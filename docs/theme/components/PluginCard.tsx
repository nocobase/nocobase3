        ...
        >
          <Badge type='warning'>
            <h6 style={{ margin: 0, fontSize: '14px', fontWeight: 500 }}>
              ...
              <a
                target='_blank'
                href='https://www.nocobase.com/cn/plugins-bundles'
                style={{ textDecoration: 'none' }}
              >
                2{' '}
                <i
                  className='uil uil-moon-eclipse'
          ...
          {editionLevel >= 0 && (
            <Badge type={EditionLevelsTypes[editionLevel as number]}>
              {lang === 'cn'
                ...
                : EditionLevelsEN[editionLevel as number]}
              +
            </Badge>
          )}
          {version && (
          ...
          >
            {pricing.plan1 && (
              <h6 style={{ margin: 0, color: '#2f55d4', fontSize: '14px' }}>
                ...
                <br />
                <a
                  href='/cn/plugins-bundles'
                  style={{ color: '#2f55d4', textDecoration: 'none' }}
                >
