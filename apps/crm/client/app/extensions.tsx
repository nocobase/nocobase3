...
const applicationExtensionIds = new Set([
  'nocobase-client',
...
const extensionContributions = collectAppExtensionContributions({
  extensions: Object.values(extensionModules)
    .map((module) => module.default)
    .filter((extension) => applicationExtensionIds.has(extension.id)),
  appRoutes,
  registryRoutesEnabled,
});
...
export const configuredStandaloneRouteElements = renderAppRoutes(
  standaloneAppRoutes,
  {
    AccessGuard: RouteAccessGuard,
  },
