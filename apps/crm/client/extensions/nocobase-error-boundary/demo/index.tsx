  ...
  return (
    <div className='fixed inset-0 z-50 overflow-auto bg-background'>
      <NocoBaseRuntimeStatus
        ...
        onRetry={onClose}
        onLogout={
          scenario.code === 'USER_HAS_NO_ROLES_ERR' ? onClose : undefined
        }
        context={{
    ...
    <div className='space-y-6'>
      ...
      <div className='grid gap-4 xl:grid-cols-2'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Best for charts, AI results, plugin surfaces, and third-party
              widgets.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              The application header and navigation remain available after a
              page failure.
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Preview the full-screen fallback used when the application shell
            cannot render.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Preview the original NocoBase error codes received over HTTP and
            WebSocket.
          </CardDescription>
        </CardHeader>
      ...
      {rootPreview && (
        <RootBoundaryPreview onClose={() => setRootPreview(false)} />
      )}
      {runtimePreview !== undefined && (
        <RuntimeStatusPreview
          index={runtimePreview}
          onClose={() => setRuntimePreview(undefined)}
        />
      )}
    </div>
  );
