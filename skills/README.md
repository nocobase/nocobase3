...
3. Reports the URL and the first sign-in account, and asks you to start a new session in the application directory, where the application's own Skills take over.
